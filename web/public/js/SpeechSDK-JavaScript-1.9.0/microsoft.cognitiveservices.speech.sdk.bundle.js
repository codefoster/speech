    ...
    function IntentConnectionFactory() {
        ...
        _this.create = function (config, authInfo, connectionId) {
            ...
            if (!endpoint) {
                ...
                var host = config.parameters.getProperty(Exports_2.PropertyId.SpeechServiceConnection_Host, "wss://speech.platform.bing.com");
                endpoint = host + "/speech/" + _this.getSpeechRegionFromIntentRegion(region) + "/recognition/interactive/cognitiveservices/v1";
            }
            var queryParams = {
                format: "simple",
...
(function (PropertyId) {
     ...
     */
    PropertyId[PropertyId["SpeechServiceConnection_Host"] = 39] = "SpeechServiceConnection_Host";
...
Object.defineProperty(exports, "__esModule", { value: true });
var DialogConnectorFactory_1 = __webpack_require__(79);
var Exports_1 = __webpack_require__(25);
var Contracts_1 = __webpack_require__(32);
var Exports_2 = __webpack_require__(30);
var PropertyId_1 = __webpack_require__(56);
...
var Exports_3 = __webpack_require__(30);
var Exports_4 = __webpack_require__(25);
var SpeechConnectionMessage_Internal_1 = __webpack_require__(86);
var ServiceRecognizerBase = /** @class */ (function () {
                    ...
                    if (connectionMessage.requestId.toLowerCase() === _this.privRequestSession.requestId.toLowerCase()) {
                        switch (connectionMessage.path.toLowerCase()) {
                            ...
                            case "turn.end":
                                ...
                                break;
                            default:
                                if (!_this.processTypeSpecificMessages(connectionMessage, successCallback, errorCallBack)) {
    ...
    ServiceRecognizerBase.prototype.sendWaveHeader = function (connection) {
        return connection.send(new SpeechConnectionMessage_Internal_1.SpeechConnectionMessage(Exports_2.MessageType.Binary, "audio", this.privRequestSession.requestId, null, this.audioSource.format.header));
    };
...
var System = /** @class */ (function () {
    function System() {
        ...
        var SPEECHSDK_CLIENTSDK_VERSION = "1.9.0";
        this.name = "SpeechSDK";
    ...
    function TranslationConnectionFactory() {
        ...
        _this.create = function (config, authInfo, connectionId) {
            ...
            if (!endpoint) {
                ...
                var host = config.parameters.getProperty(Exports_2.PropertyId.SpeechServiceConnection_Host, "wss://" + region + ".s2s.speech.microsoft.com");
...
Object.defineProperty(exports, "__esModule", { value: true });
var Exports_1 = __webpack_require__(4);
var RecognitionEvents_1 = __webpack_require__(84);
var ServiceTelemetryListener_Internal_1 = __webpack_require__(105);
...
var Exports_2 = __webpack_require__(4);
var Exports_3 = __webpack_require__(30);
var DialogServiceTurnStateManager_1 = __webpack_require__(109);
var Exports_4 = __webpack_require__(25);
var ActivityResponsePayload_1 = __webpack_require__(111);
var SpeechConnectionMessage_Internal_1 = __webpack_require__(86);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Error_1 = __webpack_require__(10);
var DialogServiceTurnState_1 = __webpack_require__(110);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Exports_1 = __webpack_require__(4);
var WebsocketMessageAdapter_1 = __webpack_require__(116);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Exports_1 = __webpack_require__(4);
var HttpsProxyAgent = __webpack_require__(123);
var ws = __webpack_require__(124);
var ocsp = __webpack_require__(125);
var WebsocketMessageAdapter = /** @class */ (function () {
    function WebsocketMessageAdapter(uri, connectionId, messageFormatter, proxyInfo, headers) {
        ...
        this.open = function () {
            ...
            try {
                var enableOCSP = process.env.NODE_TLS_REJECT_UNAUTHORIZED !== "0" && !_this.privUri.startsWith("ws:");
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(117), __webpack_require__(118).Buffer))
