...
export class AudioConfigImpl extends AudioConfig implements IAudioSource {
        ...
        /**
            ...
            */
        get format(): AudioStreamFormatImpl;
        /**
...
export enum PropertyId {
        ...
        /**
            ...
            */
        SpeechServiceConnection_Host = 39
}
...
export class TranslationServiceRecognizer extends ServiceRecognizerBase {
    ...
    protected processTypeSpecificMessages(connectionMessage: SpeechConnectionMessage, successCallback?: (e: TranslationRecognitionResult) => void, errorCallBack?: (e: string) => void): boolean;
...
export class SpeechServiceRecognizer extends ServiceRecognizerBase {
    ...
    protected processTypeSpecificMessages(connectionMessage: SpeechConnectionMessage, successCallback?: (e: SpeechRecognitionResult) => void, errorCallBack?: (e: string) => void): boolean;
    protected cancelRecognition(sessionId: string, requestId: string, cancellationReason: CancellationReason, errorCode: CancellationErrorCode, error: string, cancelRecoCallback: (e: SpeechRecognitionResult) => void): void;
}
...
export class IntentServiceRecognizer extends ServiceRecognizerBase {
    ...
    protected processTypeSpecificMessages(connectionMessage: SpeechConnectionMessage, successCallback?: (e: IntentRecognitionResult) => void, errorCallBack?: (e: string) => void): boolean;
    protected cancelRecognition(sessionId: string, requestId: string, cancellationReason: CancellationReason, errorCode: CancellationErrorCode, error: string, cancelRecoCallback: (e: SpeechRecognitionResult) => void): void;
}
